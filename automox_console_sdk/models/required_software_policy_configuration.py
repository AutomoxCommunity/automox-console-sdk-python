...
class RequiredSoftwarePolicyConfiguration(object):
    ...
    def __init__(self, auto_patch=None, notify_user=None, missed_patch_window=None, os_family=None, package_name=None, package_version=None, installation_code=None):  # noqa: E501
