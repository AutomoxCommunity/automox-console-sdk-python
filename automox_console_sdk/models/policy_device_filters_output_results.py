...
class PolicyDeviceFiltersOutputResults(object):
    ...
    def __init__(self, id=None, uuid=None, name=None, custom_name=None, os_version=None, os_family=None, server_group=None, tags=None, ip_addr=None, ip_addrs_private=None):  # noqa: E501
