...
class CustomPolicyConfiguration(object):
    ...
    def __init__(self, auto_reboot=None, notify_reboot_user=None, device_filters_enabled=None, device_filters=None, missed_patch_window=None, os_family=None, evaluation_code=None, remediation_code=None):  # noqa: E501
