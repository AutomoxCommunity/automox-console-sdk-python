...
class PoliciesApi(object):
    ...
    def generate_policy_device_filter_preview(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_policy_device_filter_preview(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PolicyDeviceFiltersPreview body: (required)
        :param int o: Organization ID. If omitted, results will include all organizations for the authenticated user.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.generate_policy_device_filter_preview_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.generate_policy_device_filter_preview_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def generate_policy_device_filter_preview_with_http_info(self, body, **kwargs):  # noqa: E501
        """Policy Device Filters Preview  # noqa: E501

        Generate a preview of the list of devices that matches the provided device filter set. For more information, see [Device Filter Preview - Filter Parameters](/developer-portal/device-filters).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.generate_policy_device_filter_preview_with_http_info(body, async_req=True)
        >>> result = thread.get()
    ...
    def get_policy_stats(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param int o: Organization ID for retrieving policy stats.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_policy_stats_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_policy_stats_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_policy_stats_with_http_info(self, **kwargs):  # noqa: E501
        """List Policy Compliance Stats  # noqa: E501

        Retrieve policy compliance statistics for all policies.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_policy_stats_with_http_info(async_req=True)
        >>> result = thread.get()
