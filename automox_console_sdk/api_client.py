...
from automox_console_sdk import rest
from automox_console_sdk.configuration import Configuration
from automox_console_sdk.exceptions import ApiTypeError, ApiValueError, ApiException
from automox_console_sdk.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_user_api_key  # this is an instance of the class Endpoint
        api_instance.create_user_api_key()  # this invokes api_instance.create_user_api_key.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_user_api_key.callable or self.callable in this class
